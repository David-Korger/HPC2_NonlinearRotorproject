#include "hpc.h"
// David: Runs through all triangles in elements-file and searches all edges in structure,
// then saves start- and endpoint for each of the edges in a row of the matrix edge2no
